...
selectServidores.addEventListener("change", function() {
    ...
    document.getElementById("nombreserv_columna_canales").innerHTML=`Servidor: ${opcionSeleccionada.text}`;
    ...
    select_canales.addEventListener("change",function(){
        ...
        console.log("canal seleccionado:", opcion_seleccionada.text);
        document.getElementById("titulo_main_canal").innerHTML = `Canal: ${opcion_seleccionada.text}`;
